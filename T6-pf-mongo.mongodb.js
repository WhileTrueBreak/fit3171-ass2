...
// print(JSON.stringify(db.clinic.find()));
db.clinic.find();
...
// ENSURE that your query is formatted and has a semicolon
// (;) at the end of this answer
db.clinic.find({ "vets.specialisation": { $in: ["Dermatology", "Cardiology"] } }).pretty();
...
db.clinic.updateOne(
	{ "_id": 5 },
	{ $push: { "vets": { "id": 1020, "name": "Sarah Wilkinson", "specialisation": "Dentistry" } } }
);
db.clinic.updateOne(
	{ "_id": 5 },
	{ $inc: { "no_of_vets": 1 } }
